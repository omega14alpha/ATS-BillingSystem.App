namespace ATS_BillingSystem.App.Infrastructure.Constants
{
    ...
    {
        public static readonly string TargetPhoneBusy = "Target phone number is busy.";

        public static readonly string TargetPhoneDisconected = "Target phone number is disconected.";

        public static readonly string InitiateCall = "Initiate call on number {0}.";

        public static readonly string StopCall = "Stop call on number {0}.";
